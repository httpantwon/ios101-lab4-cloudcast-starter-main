...
class ForecastViewController: UIViewController {
  ...
  @IBOutlet weak var forecastImageView: UIImageView!
    ...
    private var locations = [Location]() // stores the differeent locations
    private var selectedLocationIndex = 0 //Keeps track of current selected location
    override func viewDidLoad() {
        ...
        changeLocation(widthLocationIndex: 0)
    }
    private func changeLocation(widthLocationIndex locationIndex: Int) {
    ...
    @IBAction func didTapBackButton(_ sender: UIButton) {
        ...
        changeLocation(widthLocationIndex: selectedLocationIndex)
    }
